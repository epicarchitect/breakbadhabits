...
interface InstantRangeDuration : ClosedRange<Instant> {
    val duration: Duration
}

class SafeInstantRangeDuration(range: ClosedRange<Instant>) : InstantRangeDuration, ClosedRange<Instant> by range.ascended() {
