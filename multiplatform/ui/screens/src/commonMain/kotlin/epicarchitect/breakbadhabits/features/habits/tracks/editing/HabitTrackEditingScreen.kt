...
fun HabitTrackEditing(dependencies: HabitTrackEditingDependencies) {
    ...
    Column(
        ...
        habit?.let {
            Text(
                modifier = Modifier.padding(horizontal = 16.dp),
                text = dependencies.resources.habitNameLabel(it.name),
        ...
        TextField(
            ...
            error = (validatedEventCount as? IncorrectHabitTrackEventCount)?.let {
                dependencies.resources.trackEventCountError(it.reason)
            },
        )
        ...
        Text(
            modifier = Modifier.padding(horizontal = 16.dp),
            text = dependencies.resources.commentDescription()
        )
        ...
        Text(
            modifier = Modifier
                ...
                .align(Alignment.End),
            text = dependencies.resources.finishDescription()
        )
