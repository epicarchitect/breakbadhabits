...
import epicarchitect.breakbadhabits.features.habits.details.HabitDetailsResources
...
class LocalizedHabitDetailsResources(locale: Locale) : HabitDetailsResources by (
