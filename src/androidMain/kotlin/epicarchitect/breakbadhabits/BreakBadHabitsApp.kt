...
private fun handleDarkMode() {
    Environment.database.appSettingsQueries.settings().flowOfOneOrNull().onEach {
        AppCompatDelegate.setDefaultNightMode(
            when (it?.theme) {
                epicarchitect.breakbadhabits.database.AppSettingsTheme.LIGHT -> AppCompatDelegate.MODE_NIGHT_NO
                epicarchitect.breakbadhabits.database.AppSettingsTheme.DARK -> AppCompatDelegate.MODE_NIGHT_YES
