...
import breakbadhabits.android.app.database.HabitsAppWidgetConfig
...
class AppWidgetsRepository(
    ...
    private fun HabitsAppWidgetConfig.toHabitsAppWidgetConfigEntity() =
        breakbadhabits.android.app.database.HabitsAppWidgetConfig(
            id,
            title,
            appWidgetId,
            Json.encodeToString(habitIds)
    ...
    private fun breakbadhabits.android.app.database.HabitsAppWidgetConfig.toHabitsAppWidgetConfig() =
        HabitsAppWidgetConfig(
            id,
            title,
            appWidgetId,
